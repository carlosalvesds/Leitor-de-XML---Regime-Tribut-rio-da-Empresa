...
st.write("Envie um arquivo ZIP contendo arquivos XML de NF-e. O sistema irá extrair CNPJ, Nome da Empresa e o Regime Tributário.")
...
def gerar_excel_formatado(df, caminho_saida, total_lidos, removidos):
...
if uploaded_file is not None:
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        if dados:
            ...
            gerar_excel_formatado(df, excel_path, total_lidos, removidos)
